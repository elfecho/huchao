  ...
  wx.request({
    ...
    success: function (res) {
      that.setData({
        ...
        region: [res.data.info.NvrFd2, res.data.info.NvrFd3, res.data.info.NvrFd4]
      });
      stopPullDownRefresh();
...
Page({
  ...
  saveClick: function (e) {
    ...
    var city = that.data.region[0] + that.data.region[1] + that.data.region[2]
    ...
    save(that.data.curid, Receiver, Mobile, Address, city, that.data.selectedCode, that.data.region[0], that.data.region[1], that.data.region[2])
  },
...
function save(_id, Receiver, Mobile, Address, city, _code, c0, c1, c2) {
  wx.request({
